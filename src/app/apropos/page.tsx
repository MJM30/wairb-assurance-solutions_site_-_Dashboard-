              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between group">
                ...
                <div className="w-full md:w-1/2 pl-24 md:pl-16 text-left relative">
                  <Reveal animation="reveal-right">
                    ...
                    <p className="text-muted-foreground leading-relaxed">Création à <strong className="text-primary">Kinshasa (République Démocratique du Congo)</strong>. Une étape décisive pour nous rapprocher des marchés dynamiques d'Afrique centrale et renforcer notre présence continentale.</p>
                  </Reveal>
                </div>
                {/* Mobile Date */}
      ...
      <section id="gouvernance" className="py-24 bg-white">
        <div className="container">
          <div className="flex flex-wrap -mx-4 items-center">
            {/* Text Side - Left */}
            <div className="w-full lg:w-1/2 px-8 lg:px-16 order-2 lg:order-1">
              <Reveal animation="reveal-left">
                <span className="badge-primary mb-4">Gouvernance</span>
                <h2 className="text-3xl md:text-5xl font-extrabold mb-8 leading-tight">
                  Conseil d'<span className="text-primary">Administration</span>
                </h2>
                <p className="text-lg text-muted-foreground mb-6">
                  Une équipe de visionnaires guidant WAIRB DRC SAS vers l'excellence et l'intégrité.
                </p>
                <p className="text-base text-foreground mb-4 leading-relaxed">
                  WAIRB a eu l'honneur de se voir confié la gestion de plusieurs marchés d'assurances et de Réassurance; De la gestion de marché confié par l'Etat Ivoirien d'une valeur totale de 326 065 896 657 FCFA Soit 497 084 055 EURO, en passant par la signature de partenariat privilégié à travers le monde, jusqu'à la gestion de la réassurance complète de compagnies d'assurances.
                </p>
                <p className="text-base text-foreground leading-relaxed">
                  Fort de notre capital humain et de nos valeurs, notre compagnie poursuit sa politique de développement avec une grande rigueur, au service de la satisfaction de nos assurés.
                </p>
              </Reveal>
            </div>
            
            {/* Photo Side - Right */}
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0 order-1 lg:order-2">
               <div className="grid grid-cols-1 gap-6 max-w-md mx-auto">
                  <Reveal animation="reveal-right">
                    <div className="relative group">
                      <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-xl">
                        <img src="/images/madame_kone.jpg" alt="Manager General du groupe" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 object-top" />
                      </div>
                      <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl max-w-[240px]">
                        <h4 className="font-bold text-lg">Direction du groupe</h4>
                        <p className="text-primary text-sm font-semibold">Manager General</p>
                      </div>
                    </div>
                  </Reveal>
               </div>
                  ...
                  <Reveal animation="reveal-left">
                    <div className="relative group">
                      ...
                      <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl max-w-[240px]">
                        <h4 className="font-bold text-lg">Directeur Regional Afrique central du group</h4>
                        <p className="text-green-600 text-sm font-semibold">Président WAIRB DRC</p>
                      </div>
                    </div>
                  </Reveal>
               </div>
