      ...
      <div className="container">
        <div className="max-w-xl mb-12">
          ...
          <Reveal animation="reveal" delay={200}>
            <h2 className="text-2xl md:text-3xl font-extrabold text-foreground mb-3 tracking-tight">
              Nos solutions d'assurances et de réassurance adaptées à vos besoins
            </h2>
          </Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
          ...
          <Reveal animation="reveal-left">
            <Link href="/nos-solutions" className="group h-full bg-white border border-primary/5 rounded-[2rem] p-8 md:p-10 card-shadow hover:shadow-2xl transition-all duration-500 relative overflow-hidden block cursor-pointer">
          ...
          <Reveal animation="reveal-left" delay={200}>
            <Link href="/nos-solutions" className="group h-full bg-green-900 border border-green-800 rounded-[2rem] p-8 md:p-10 card-shadow hover:shadow-2xl transition-all duration-500 relative overflow-hidden block cursor-pointer">
              ...
              <div className="relative z-10 text-white">
                ...
                <div className="mt-10 pt-8 border-t border-green-800 flex items-center">
                  <div className="flex items-center gap-2 text-xs font-bold text-white/80 group-hover:gap-3 transition-all">
                    En savoir plus
                    <ArrowRight className="h-4 w-4" />
                  </div>
                </div>
